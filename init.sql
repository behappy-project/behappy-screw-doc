create database screw_doc;
use screw_doc;
create table screw_doc.sys_database
(
...
create table screw_doc.sys_database_history
(
...
create table screw_doc.sys_dict
(
    name varchar(255) null comment '名称',
...
create table screw_doc.sys_role
(
    id int auto_increment comment 'id'
        primary key,
...
create table screw_doc.sys_role_database
(
...
create table screw_doc.sys_user
(
    id int auto_increment comment 'id'
        primary key,
