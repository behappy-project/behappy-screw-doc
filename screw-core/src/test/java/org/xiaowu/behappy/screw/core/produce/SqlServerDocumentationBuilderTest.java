...
import org.xiaowu.behappy.screw.core.common.Constants;
 ...
 *
 * @author SanLi
 * Created by qinggang.zuo@gmail.com / 2689170096@qq.com on 2020/3/30 18:34
 */
public class SqlServerDocumentationBuilderTest extends AbstractDocumentationExecute {
    ...
    void build() throws IOException {
        ...
        EngineConfig engineConfig = EngineConfig.builder()
            //生成文件路径
            .fileOutputDir(Constants.fileOutputDir)
            //文件类型
