 ...
 */
package org.xiaowu.behappy.screw.core.querys;

import org.xiaowu.behappy.screw.core.common.Properties;
 ...
 */
public class SqlServerDataBaseQueryTest implements Properties {
    /**
     * 日志
     */
    ...
    void column() throws QueryException {
        List<? extends Column> columns = query.getTableColumns("Activity");
    ...
    @Test
    void primaryKeys() {
        List<? extends PrimaryKey> primaryKeys = query.getPrimaryKeys("Activity");
